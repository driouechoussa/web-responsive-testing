...
const TopicHeader_items = document.querySelectorAll('Topic-item');
...
function ShowMessageBox() {
    ...
    MessageBoxWrapper.setAttribute('id','MessageBox-Wrapper');
    document.body.appendChild(MessageBoxWrapper);
